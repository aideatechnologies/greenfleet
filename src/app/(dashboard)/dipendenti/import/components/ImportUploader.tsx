...
type ImportUploaderProps = {
  onFileSelected: (file: File, config: EmployeeImportConfig) => void;
  config: EmployeeImportConfig;
  onConfigChange: (config: EmployeeImportConfig) => void;
};
...
export function ImportUploader({
  ...
  const isCSV =
    selectedFile?.name.toLowerCase().endsWith(".csv") ?? false;
